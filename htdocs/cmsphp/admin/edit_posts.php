...
<form method="post" action="edit_posts.php?edit_form=<?php 
echo $post_id; ?>" enctype=
"multipart/form-data">
	...
	<table width="600" bgcolor="orange" align="center" border="10">
		...
		<tr>
			...
			<td><input type="file" name="image"><img src="../images/<?php echo $post_image?>" width="100" height="100"> </td>
		</tr>
		...
		<tr>
			...
			"submit" name="submit" value="Update Now"></td>
		</tr>
...
if(isset($_POST['submit'])){
	...
	if($post_title1=='' or $post_keywords1=='' or $post_content1=='' or $post_author1=='' or $post_image1==''){
